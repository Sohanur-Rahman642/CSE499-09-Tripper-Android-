...
public class MapView extends FragmentActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomSheetBehavior = BottomSheetBehavior.from(layout_explore_nearby);
        ...
        textView_explorer = (TextView) findViewById(R.id.textview_explore);
        ...
        mFusedLocationProviderClient = LocationServices
                .getFusedLocationProviderClient(MapView.this);
    ...
    public void onBackPressed(){
        finish();
        Intent intent = new Intent(MapView.this,MyToursForGuide.class);
        ...
        task.addOnFailureListener(MapView.this,new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                if(e instanceof ResolvableApiException){
                    ...
                    try {
                        resolvableApiException.startResolutionForResult(MapView.this,51);
