...
public class SignupForGuide extends AppCompatActivity {
    ...
    private ImageView guide_propic1;
    ...
    private void init3(){
        ...
        guide_propic1=(ImageView) findViewById(R.id.guide_propic1);
    }
                    ...
                    firebaseAuth.createUserWithEmailAndPassword(email, pas).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                finish();
                                startActivity(new Intent(SignupForGuide.this, LoginForGuide.class));
                            } else {
