...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MessageViewHolder> {
    ...
    public MessageViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View V = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.message_layout_of_users, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder messageViewHolder, int i) {
        ...
        MessagesModel messages = userMessagesList.get(i);


        String fromUserID = messages.getFrom();
        String fromMessageType = messages.getType();

        usersDatabaseRef = FirebaseDatabase.getInstance().getReference().child("Packages").child(fromUserID);   //before it was "Users"
